...
```
### Analysis
Looking at the individuals stocks, we see that Netflix has the highest Sharpe Ratio of 6.370,
and thus has the most attractive risk-adjusted return. However, Google and Meta are not far
behind at 5.415 and 4.884. Thus, the tangential portfolio puts the highest weight on NFLX, but
still a significant proportion in the others. All of them are above 3 and thus very good stocks to invest in.
The Sharpe Ratio of the tangency portfolio is higher than each individual stock, at 6.873. This is much
higher than the Sharpe Ratio of VOX, which is at -0.054.
...
Interestingly, unlike in 2017-2019, the Beta for the tangency portfolio is lower than two of the three sub-components. The betas also varied a lot more in 2017-2019.
