...
ri_tang =  tan.vec[1] * ri_goog + tan.vec[2] * ri_meta + tan.vec[3] * ri_nflx # monthlyReturn(tang, type = "arithmetic")
...
ri_tang_new =  tan.vec[1] * ri_goog_new + tan.vec[2] * ri_meta_new + tan.vec[3] * ri_nflx_new #monthlyReturn(tang_new, type = "arithmetic")
...
#TODO: need to verify this is correct, changed inputs from price to return for 7/8
